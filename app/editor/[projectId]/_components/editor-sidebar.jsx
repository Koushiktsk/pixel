...
import { AdjustControls } from "@/app/(main)/dashboard/_components/_tools/adjust";
import { BackgroundControls } from "@/app/(main)/dashboard/_components/_tools/background-controls";
import { useCanvas } from "@/context/context";
import { TextControls } from "@/app/(main)/dashboard/_components/_tools/text";
import { AIExtenderControls } from "@/app/(main)/dashboard/_components/_tools/ai-extend";
import { ResizeControls } from "@/app/(main)/dashboard/_components/_tools/resize";
import { AIEdit } from "@/app/(main)/dashboard/_components/_tools/ai-edit";
import { CropContent } from "@/app/(main)/dashboard/_components/_tools/crop"; 
